...
class SignedTelmetryPublicKey(models.Model):
    ...
    is_active = models.BooleanField(default=False, help_text = "Specify if the key is active, only active keys will be validated against in the signed telemetry feeds")
