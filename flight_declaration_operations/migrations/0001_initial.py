    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.IntegerField(choices=[(0, 'Accepted'), (1, 'Activated'), (2, 'Contingent'), (3, 'Nonconforming'), (4, 'Completed')], default=0, help_text='Set / Update the current state of the operations')),
