"""
Django settings for argon_server project.
...
ROOT_URLCONF = "argon_server.urls"
...
WSGI_APPLICATION = "argon_server.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.path.join(BASE_DIR, "argon_server.sqlite3"),
    }
}
DATABASES = {}
...
if USE_LOCAL_SQLITE_DATABASE:
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_DATABASE", os.path.join(BASE_DIR, "argon_server.sqlite3")),
        }
    }
else:
