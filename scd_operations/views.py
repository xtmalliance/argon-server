...
from common.data_definitions import OPERATION_STATES, OPERATION_STATES_LOOKUP
...
def SCDAuthTest(request, operation_id):
    ...
    if request.method == "PUT":
        ...
        same_operational_intent_exists_in_blender = my_test_harness_helper.check_if_same_flight_id_exists(operation_id=operation_id_str)
