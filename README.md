...
- To begin, review the [API Specification](http://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/openutm/flight-blender/master/api/argon-server-1.0.0-resolved.yaml) to understand the endpoints and the kind of data that you can set in Argon Server.
