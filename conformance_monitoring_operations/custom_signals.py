...
def process_telemetry_conformance_message(sender, **kwargs):  
    ...
    non_conformance_state_label = ConformanceChecksList.label(non_conformance_state)
    
    if non_conformance_state_label == 'C3':
    ...
    elif non_conformance_state_label in ['C4','C5']:
    ...
    elif non_conformance_state_label == 'C6':        
    ...
    elif non_conformance_state_label == 'C7a':
    ...
    elif non_conformance_state_label == 'C7b':
...
def process_flight_authorization_conformance_message(sender, **kwargs):    
    ...
    my_operation_notification = OperationConformanceNotification(flight_declaration_id=flight_declaration_id)
    non_conformance_state_label = ConformanceChecksList.label(non_conformance_state)
    print(non_conformance_state_label)
    message = '{} -- {}'.format(sender, kwargs['non_conformance_state'])
    print(message)

    if non_conformance_state_label == 'C9a':
    ...
    elif non_conformance_state_label == 'C9b':
        ...
        #TODO: Uncomment
        # management.call_command('operation_declares_contingency', flight_declaration_id = flight_declaration_id, dry_run = True)
    elif non_conformance_state_label == 'C10':
