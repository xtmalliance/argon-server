...
| IS_DEBUG |integer | Set this as 1 if you are using it locally, **NOTE** Please remove this field totally for any production deployments, it will by pass token verification and will be a security risk |
